...
class RPSCustomPainterPopup extends CustomPainter {
  final double scrrenWidth;

  RPSCustomPainterPopup(this.scrrenWidth);
  @override
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint_1_fill = Paint()
      ..shader =
          ui.Gradient.sweep(Offset(scrrenWidth / 2.6, (scrrenWidth) / 2), [
